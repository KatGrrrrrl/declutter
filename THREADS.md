...
| 8 | QA (this session) | 🟢 Running | Sep 14 | **Sep 14:** re-checked the finished login/sync rebuild — sign-ins, permissions and two-device sync all pass; the "wrong tabs after refresh" bug is fixed and live. **Sep 9:** full site check found 7 must-fix problems (4 now fixed by the rebuild), plus stub screens, untrue copy, and readability issues for older users. Plain-language reports: `docs/QA-2026-09-14.md`, `docs/QA-2026-09-09.md`. |
